use {
    ...
    crate::error::Error::{self, AccountInitialized, InvalidAccountType, InvalidOwner},
...
impl AccountType {
    pub fn init(info: &AccountInfo, new: AccountType) -> std::result::Result<(), Error> {
    ...
    pub fn check_owner(info: &AccountInfo, program_id: &Pubkey) -> std::result::Result<(), Error> {
    ...
    pub fn is_ok(info: &AccountInfo, typ: Self, program_id: &Pubkey) -> std::result::Result<(), Error> {
